...
<div class="new_page_container">
	<table class="new_page_table">
		...
		<tr>
			...
			<td><input type="text" style="width:120px"> - <input type="text" style="width:135px"> - <input type="text" style="width:135px"></td>
		</tr>
		<tr>
			<td class="title">단지명/면적</td>
			<td colspan="2">
				<select style="width:200px"><option>건물명</option></select>&nbsp;&nbsp;&nbsp;
				<input type="text" style="width:105px"> 분양평형 <input type="text" style="width:105px"> 실평형
			</td>
		...
		<tr>
			...
			<td colspan="4">
				<input type="radio" name="interior_rb" id="interior_rb1" class="rbbox" /><label for="interior_rb1" class="rb-label interior">있음</label>&nbsp;&nbsp;
				<input type="radio" name="interior_rb" id="interior_rb2" class="rbbox" /><label for="interior_rb2" class="rb-label interior">없음</label>
			</td>
		</tr>
		<tr>
