...
<script type="text/javascript" src="./resources/js/list/objtList.js?v20180205"></script>	
<body >
		...
		<table style="background-color :#F6F8F7;" width="1500px" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<td width="100%" align="right" valign="bottom">
					...
					<input type="checkbox" name="activeTp4" id="activeTp4" onclick = "f_objtCkbox_check(this)" value="AT003" /><label for="activeTp4">내가등록한물건만보기</label>
				</td>	
			</tr>
		</table>
		<table style="background-color :#F6F8F7;" width="1500px" cellpadding="0" cellspacing="0" border="0">
