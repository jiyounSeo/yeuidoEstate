...
<div class="new_page_container">
	<table class="new_page_table">
		...
		<tr>
			...
			<td colspan="2"><select style="width:350px"><option>주상복합명</option></select>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" style="width:135px"> 평형</td>
		...
		<tr>
			...
			<td colspan="4"><input type="text" style="width:140px"> 개 / <input type="text" style="width:140px"> 개</td>
		</tr>
		<tr>
