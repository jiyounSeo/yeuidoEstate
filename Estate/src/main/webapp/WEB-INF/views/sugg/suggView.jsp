...
<div class="new_page_container">
	<table class="new_suggbd_table">
		<tr><td width="155px" class="title">제목</td><td width="930px" colspan="3">${item.mbrNm} 님이 작성한 건의사항입니다</td></tr>
		<tr><td width="155px" class="title">글쓴이</td><td width="930px">${item.mbrNm}</td><td width="155px" class="title">날짜</td><td width="200px">${item.frstRegDt}</td></tr>
...
<div class="new_page_container" style="text-align: center;" id="btnDiv">
	...
	<c:if test="${item.frstRegUser == sessionScope.user.mbrId || sessionScope.user.mbrTp == 'MT003' || sessionScope.user.mbrTp == 'MT004'}">
