		...
		<div class="new_page_container">
			<table class="new_report_table">
				...
				<tr>
					...
					<td class="sub">					
						<input type="radio" name="contSe" id="contSe_rb1" class="rbbox" /><label for="contSe_rb1" class="rb-label type">양타</label>&nbsp;&nbsp;
						<input type="radio" name="contSe" id="contSe_rb2" class="rbbox" /><label for="contSe_rb2" class="rb-label type">공동중개</label>&nbsp;&nbsp;
					</td>
				</tr>
				<tr>
