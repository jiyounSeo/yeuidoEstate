		...
		<div class="new_page_container">
			<table class="new_report_table">
				...
				<tr>
					...
					<td><input type="text" onkeyup="inputNumberFormat(this)" maxLength="15" style="width:60%" id="contAmt" name="contAmt" value="${result.contAmt}"> 원</td>
				</tr>
				<tr>
					...
					<td><input type="text" onkeyup="inputNumberFormat(this)" maxLength="15" style="width:60%" id="midContAmt" name="midContAmt" value="${result.midContAmt}"> 원</td>
				</tr>
				<tr>
					...
					<td><input type="text" onkeyup="inputNumberFormat(this)" maxLength="15" style="width:60%" id="remainAmt" name="remainAmt" value="${result.remainAmt}"> 원</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" onkeyup="inputNumberFormat(this)" maxLength="10" style="width:50%" id="preFees" name="preFees" value="${result.preFees}"> 원</td>
					<td class="title">실제수수료</td>
					<td><input type="text" onkeyup="inputNumberFormat(this)" maxLength="10" style="width:50%" id="realFees" name="realFees" value="${result.realFees}"> 원</td>
				</tr>
				<tr>
