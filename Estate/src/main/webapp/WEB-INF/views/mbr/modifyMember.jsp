...
<script type="text/javascript" src="./resources/js/mbr/modifyMember.js"></script>
...
<form id="joinMember" method="post" > 
	...
	<div style="width:342px; height:727px;text-align:left;background-image: url(./resources/images/reg_bg.jpg); margin:auto; padding-left: 54px; padding-right: 54px">		
		...
		<div style="height: 100%; width: 342px;">
			<table width="342px" cellpadding="0" cellspacing="0" border="0">
				...
				<tr><td height="42px"><input type="text" id="loginId" name="loginId" disabled="true" class="mbr_txt essential onlyEng" maxlength="16" value='${loginId}'></td></tr>
				...
				<tr><td height="42px"><input type="text" id="mbrNm" name="mbrNm" class="mbr_txt essential" maxlength="50" value='${mbrNm}'></td></tr>
				<tr><td height="5px"></td></tr>
				<tr><td height="42px" valign="bottom"><img src="./resources/images/t_phone.jpg"></td></tr>
				<tr>
					<td height="42px">
						<input type="text" id="tel1" name="tel1" class="mbr_phone essential onlyNum" maxlength="4" value='${tel1}'>  -  
						<input type="text" id="tel2" name="tel2" class="mbr_phone essential onlyNum" maxlength="4" value='${tel2}'>  -  
						<input type="text" id="tel3" name="tel3" class="mbr_phone essential onlyNum" maxlength="4" value='${tel3}'>
					</td>
				</tr>
	...
	<input type="hidden" name="estate" id="estate" value='${estateCd}'/> 
