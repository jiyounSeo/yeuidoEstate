  ...
  <script type="text/javascript" src="./resourcesjs/mbr/memberList.js"></script>
    ...
    <div style="width:1205px; text-align:left; margin:auto; padding:0">		
		<table style="width: 1205px;" cellpadding="0" cellspacing="0" border="0">
			<tr><td height="40"><img src="./resourcesimages/mbr_title.jpg"></td></tr>
		</table>
	</div>
	...
	<div style="width:1200px; text-align:left; margin:auto; box-shadow:0 0 5px #c3c3c3;">	
		<table style="width: 1200px;" cellpadding="0" cellspacing="0">
			<tr>
				<td width="94px"><img src="./resourcesimages/mbr_title_1.jpg"></td>
				<td width="148px"><img src="./resourcesimages/mbr_title_2.jpg"></td>
				<td width="166px"><img src="./resourcesimages/mbr_title_3.jpg"></td>
				<td width="211px"><img src="./resourcesimages/mbr_title_4.jpg"></td>
				<td width="210px"><img src="./resourcesimages/mbr_title_5.jpg"></td>
				<td width="168px"><img src="./resourcesimages/mbr_title_6.jpg"></td>				
				<td width="203px"><img src="./resourcesimages/mbr_title_7.jpg"></td>
			</tr>
			<tbody id="mbrTbody">
			</tbody>
		</table>
	...
	<div style="width:1200px; text-align:right; margin:auto;">
		<br>
		<a href="/estate/adminMainView.do"><img src="./resourcesimages/btn_mbr_main.jpg" border="0"></a>
	</div> 
