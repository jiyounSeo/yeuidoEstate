...
<script type="text/javascript" src="../js/list/newEstate.js?v20180204"></script>
...
$( document ).ready(function() {
	var estateCd = getHttpParam('estateCd');
	f_estate_dtl(estateCd);
});
...
<div class="popup_page_container">
	...
	<div style="width:97%;height:45px;text-align:right;padding-top:10px;">
		<a href="#"><img src="../images/btn_edit.jpg" onclick="f_estate_save();return false;"></a>
	</div>
